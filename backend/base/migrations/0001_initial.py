    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artistName', models.CharField(blank=True, max_length=200, null=True)),
                ('artistPic', models.ImageField(blank=True, null=True, upload_to='')),
                ...
                ('vertecies', models.IntegerField(blank=True, default=0, null=True)),
